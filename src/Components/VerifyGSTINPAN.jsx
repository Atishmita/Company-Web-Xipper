      ...
      >
        ...
        <div className="mt-10 space-y-1">
          <div className="font-bold text-xl">
            Verify your GSTIN and PAN Number
          </div>
          <div className="text-gray-500 text-sm font-medium w-auto">
            verification of GSTIN and PAN is mandatory for setting up your
            account
          </div>
        </div>

        <div className="mt-7">
          <div className="text-base font-semibold">Registered GSTIN Number</div>
        ...
        <div className="mt-7">
          <div className="text-base font-semibold">Registered PAN Number</div>
