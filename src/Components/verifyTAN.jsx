    ...
    <div className="flex gap-10">
      ...
      >
        ...
        <div className="mt-10 space-y-1">
          <div className="font-bold text-xl">Verify your TAN Number</div>
          <div className="text-gray-500 text-sm font-medium w-96">
            verification of PAN is mandatory for setting up your account
          </div>
        </div>

        <div className="mt-7">
          <div className="text-base font-semibold">Registered TAN number</div>
